        ...
        <>
            ...
            <AnimatedComponent y={0} opacity={0} duration={1.5} delay={0.6}>
                <div className="w-4/5 mx-auto">
                    ...
                    <div className='flex'>
                        <div className="w-1/5 h-full text-white mt-10">
                        ...
                        <div className="h-1/3 grid grid-rows-2 sm:grid-cols-2">
                            <div className="flex justify-center items-center h-1/3">
                                {/* 柱狀圖 */}
                                <Bar data={data} options={options} className='my-10 ' />
                            </div>
                            <div className="mt-2 mx-7 text-gray-300 bg-slate-800 py-1 h-1/3 w-9/10 border-slate-400 p-1 rounded-md shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-20 relative" style={{ boxShadow: '0 0 10px 5px rgba(255, 0, 0, 0.5)', overflowY: 'auto', overflowX: 'auto' }}>
